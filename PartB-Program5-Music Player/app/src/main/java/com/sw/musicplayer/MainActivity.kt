...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        forwardBtn.setOnClickListener {
            val i: Int = mediaPlayer.currentPosition
        ...
        backwardBtn.setOnClickListener {
            ...
            mediaPlayer.seekTo(i-10000)
            val contextView = findViewById<View>(R.id.root)
            val snack = Snackbar.make(contextView, "Media Backward 10 Seconds", Snackbar.LENGTH_SHORT)
            snack.show()
        }
    }
